...
const items = [
  {
    ...
    type: "img",
   // src: "",
    img: "assets/img/projects/booki/project-1.webp",
    slides: ["assets/img/projects/booki/project-1.webp","assets/img/projects/booki/booki3.webp","/assets/img/projects/booki/booki3.webp","assets/img/projects/booki/booki4.webp"],
    project: "Website",
  ...
  },
  {
    ...
    type: "img",
    //src: "",
    img: "assets/img/projects/ohMyFood/project-2.webp",
    slides: ["assets/img/projects/ohMyFood/project-2.webp","assets/img/projects/ohMyFood/fooddesktop.webp","assets/img/projects/ohMyFood/foodmobile.webp",],
    project: "Website",
    client: "Restaurant",
    img2:"/assets/img/technologyIcons/html-min.webp",
  ...
  },
  {
    ...
    type: "img",
   // src: "",
    img: "assets/img/projects/architecteSophie/project-3.webp",
    slides: ["assets/img/projects/architecteSophie/project-3.webp","assets/img/projects/architecteSophie/sophie1.webp","assets/img/projects/architecteSophie/sophie2.webp","assets/img/projects/architecteSophie/sophie3.webp","assets/img/projects/architecteSophie/sophie4.webp"],
    project: "Website",
    client: "Sophie Bluel",
    img2:"/assets/img/technologyIcons/html-min.webp",
    img3:"/assets/img/technologyIcons/css-3-min.webp",
  ...
  },
  {
    ...
    type: "local_video",
    src: "assets/img/projects/menuMakerByQwenta/solutionTechnique.mp4",
    img: "assets/img/projects/menuMakerByQwenta/project-12.webp",
    slides: ["assets/img/projects/menuMakerByQwenta/project-5.webp"],
    project: "Website",
    client: "Qwenta",
  ...
  },
  {
    ...
    type: "img",
   // src: "",
    img: "assets/img/projects/kasa/project-4.png",
    slides: ["assets/img/projects/kasa/project-4.png","assets/img/projects/kasa/kasaDesktop.png","assets/img/projects/kasa/kasaMobile.png","assets/img/projects/kasa/kasaAbout.png","assets/img/projects/kasa/kasa5.webp","assets/img/projects/kasa/kasa6.webp"],
    project: "Site Web",
    client: "Agence de location immobilière Kasa",
    img2:"/assets/img/technologyIcons/html-min.webp",
    img3:"/assets/img/technologyIcons/sass-min.webp",
    img4:"/assets/img/technologyIcons/react-min.webp",
    previewLink: "https://glowing-lebkuchen-cb4f6c.netlify.app",
    description:
...

  {
    ...
    title: "Nina Carducci",
    type: "local_video",
    src: "assets/img/projects/ninaCarducci/rapportOptimisation.mp4",
    img: "assets/img/projects/ninaCarducci/project-5.webp",
    slides: ["assets/img/projects/ninaCarducci/project-5.webp"],
    project: "Website",
  ...
  },
  {
    ...
    type: "img",
    src: "",
    img: "assets/img/projects/argentBank/project-6.webp",
    slides: ["assets/img/projects/argentBank/project-6.webp","assets/img/projects/argentBank/argentBank1.webp","assets/img/projects/argentBank/argentBank2.webp","assets/img/projects/argentBank/ArgentBank3.webp","assets/img/projects/argentBank/ArgentBankmobile.webp","assets/img/projects/argentBank/argentBankMobil3.webp"],
    project: "Website",
    client: "Agence Bancaire",
    img2:"/assets/img/technologyIcons/react-min.webp",
    img3:"/assets/img/technologyIcons/sass-min.webp",
    img4:"/assets/img/technologyIcons/redux-min.webp",
    img5:"/assets/img/technologyIcons/swagger.webp",
